        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                <div class="col">
                    ...
                    <h2 class="page-title">
                        <?=$form->title?>&nbsp;<span class="badge badge-outline text-blue" style="font-size: 10px">bearbeitungs Modus</span>
                    </h2>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-6">
                            ...
                            <input type="text" class="form-control <?php if(session('errors.title')) : ?>is-invalid<?php endif ?>" id="title" name="title" value="<?= $form->title ?>">
                            <div class="invalid-feedback"><?= old('title') ?></div>
                        </div>
                        <div class="col-6">
                            <label for="description" class="form-label">Kurze Beschreibung <span class="text-danger">*</span></label>
                            <input type="text" class="form-control <?php if(session('errors.description')) : ?>is-invalid<?php endif ?>" id="description" name="description" value="<?= $form->description ?>">
                            <div class="invalid-feedback"><?= old('description') ?></div>
                        </div>
                    </div>
                    <!--
                    <div class="row mb-3">
                        <div class="col-12">
                            ...
                            <label class="form-label">Formularstruktur</label>
                            <div id="jsoneditor" style="width: 100%; height: 800px;"></div>
                            <input type="hidden" name="json" id="json" value="<?=htmlspecialchars($form->data)?>">
                        </div>
                    </div>
                            -->
                    <div class="mb-3 row">
                        <div class="col-12">
                            ...
                            ): ?>is-invalid<?php endif; ?>"><?= $form->message_success ?></textarea>
                    ...
                    <div class="mb-3 row">
                        <div class="col-12">
                            ...
                            ): ?>is-invalid<?php endif; ?>"><?= $form->mail_confirmation ?></textarea>
                            <div class="invalid-feedback"><?= session(
                    ...
                    <div class="mb-3 row">
                        <div class="col-12">
                            ...
                            ): ?>is-invalid<?php endif; ?>"><?= $form->mail_rejected ?></textarea>
                            <div class="invalid-feedback"><?= session(
                        ...
                        <div class="col-12">
                            ...
                            <select class="form-select tomselect-multiple-check" name="notify[]" name="notify" multiple="multiple">
                                <?php foreach($users as $user): ?>
                                    <option value="<?=$user->id?>" <?= (in_array($user->id, json_decode($form->notify))) ? 'selected' : '' ?>><?=$user->email?></option>
                                <?php endforeach; ?>
                            </select>
                            <div class="invalid-feedback"><?= session(
                                "errors.mail_rejected", 
