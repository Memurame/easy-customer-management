        ...
        <div class="container-xl">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-4">
                            <label for="title" class="form-label">Auf Vorlage laden <span class="text-danger">*</span></label>
                            <select id="invoice_template" class="form-select tomselect-default">
                                <option value="0">-- Keine Vorlage --</option>
                                <?php foreach($templates as $template):?>
                                <option value="<?=$template->id?>" <?= ($currentTemplate && $currentTemplate->id == $template->id) ? 'selected' : '' ?>><?=$template->title?></option>

                                <?php endforeach;?>
                            </select>
                            <small class="form-hint">
                                Wähle eine Vorlage aus um diese zu laden.
                            </small>
                        </div>
                    </div>
                    <hr>
                    ...
                    <div class="row mb-3">
                        <div class="col-2">
                            ...
                            <input type="number" class="form-control <?php if(session('errors.position')) : ?>is-invalid<?php endif ?>" id="position" name="position" value="<?=$max['position'] ?>">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control <?php if(session('errors.title')) : ?>is-invalid<?php endif ?>" id="title" name="title"
                                value="<?= ($currentTemplate) ? $currentTemplate->title : old('title') ?>">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control <?php if(session('errors.description')) : ?>is-invalid<?php endif ?>" id="description" name="description"
                                value="<?= ($currentTemplate) ? $currentTemplate->description : old('description') ?>">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-3">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="number" name="price" step="0.01" id="price" class="form-control <?php if(session('errors.price')) : ?>is-invalid<?php endif ?>" placeholder="00.00"
                                    value="<?= ($currentTemplate) ? $currentTemplate->price : old('price') ?>">
                            </div>
                        </div>
                        <div class="col-md-3">
                            ...
                            <input type="number" step="0.01" name="multiplication" id="multiplication" class="form-control <?php if(session('errors.multiplication')) : ?>is-invalid<?php endif ?>"
                                value="<?= ($currentTemplate) ? $currentTemplate->multiplication : old('multiplication') ?>">
                        </div>
                        <div class="col-md-3">
                            <label for="unit" class="form-label">Einheit <span class="text-danger">*</span></label>
                            <input type="text" name="unit" id="unit" class="form-control <?php if(session('errors.unit')) : ?>is-invalid<?php endif ?>"
                                value="<?= ($currentTemplate) ? $currentTemplate->unit : 'Stk' ?>" placeholder="Stk">
                        </div>
                        <div class="col-md-3">
                            ...
                            <select id="mwst" name="mwst" class="form-select tomselect-default <?php if(session('errors.mwst')) : ?>is-invalid<?php endif ?>">
                                ...
                                <option value="7.7" selected>7.7%</option>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" id="price_inkl" name="price_inkl"
                                    <?= ($currentTemplate AND $currentTemplate->price_inkl) ? 'checked' : '' ?>>
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            ...
                            <textarea class="form-control" rows="5" id="notes" name="notes"><?= ($currentTemplate) ? $currentTemplate->notes : old('notes') ?></textarea>
                            <small class="form-hint">
                                Diese Notiz ist auf der rechnung nicht sichtbar. Nur für Interne Zwecke.
                            </small>
                        </div>
                    </div>
                </div>
