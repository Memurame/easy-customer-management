                        ...
                        <div class="card bg-primary text-primary-fg">
                            ...
                            <div class="card-body">
                                <form method="post" action="<?=base_url(route_to('feedback'))?>">
                                    ...
                                    <textarea name="feedback" class="form-control mb-2" data-bs-toggle="autosize" placeholder="Feedback schreiben" style="overflow: hidden; overflow-wrap: break-word; resize: none; text-align: start; height: 60px;"></textarea>
                                            ...
                                            <div class="list-group-item">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col text-truncate">
                                                        <a href="#" class="text-reset d-block"><?=profile($lastuser->id)->firstname?> <?=profile($lastuser->id)->lastname?></a>
                                                        <?php if($diff->getMinutes() < -15): ?>
