...
<div class="d-flex border-bottom pb-2 mb-4">
    ...
    <div class="">
        <a href="<?=base_url()?><?=route_to('project.add')?>" class="btn btn-outline-primary btn-sm">Neues Projekt</a>
    </div>
</div>
                ...
                <tr>
                    ...
                    <td class="text-end">
                        <div class="btn-group">
                            ...
                            <a href="#" class="delete-project btn btn-outline-danger" data-id="<?=$project->id?>"><i
