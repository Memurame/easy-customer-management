            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control <?php if(session('errors.name')) : ?>is-invalid<?php endif ?>" id="name" name="name" value="<?=old('name') ?>">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            ...
                            <div class="input-icon mb-2">
                                <input class="form-control tabler-datepicker-icon" id="date_offer" name="date_offer" value="<?=old('date_offer') ?>">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-icon mb-2">
                                <input class="form-control tabler-datepicker-icon" id="date_order" name="date_order" value="<?=old('date_offer') ?>">
                                <span class="input-icon-addon">
                                    <!-- Download SVG icon from http://tabler-icons.io/i/calendar -->
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                        stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-icon mb-2">
                                <input class="form-control tabler-datepicker-icon" id="date_finish" name="date_finish" value="<?=old('date_offer') ?>">
                                <span class="input-icon-addon">
                                    <!-- Download SVG icon from http://tabler-icons.io/i/calendar -->
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                        stroke-linecap="round" stroke-linejoin="round">
                ...
                <div class="card-footer">
                    <div class="btn-list justify-content-end">
                        <a href="<?=base_url(route_to('project.index'))?>" class="btn">
                            Abbrechen
                        </a>
