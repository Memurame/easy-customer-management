...
<form method="post">
    ...
    <div class="row g-3">
        ...
        <div class="col-md-4">
            ...
            <input type="date" class="form-control" id="date_offer" name="date_offer" value="<?=old('date_offer') ?>">
        </div>
        <div class="col-md-4">
            <label for="date_order" class="form-label">Bestellt</label>
            <input type="date" class="form-control" id="date_order" name="date_order" value="<?=old('date_order') ?>">
        </div>
        <div class="col-md-4">
