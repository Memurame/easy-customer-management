                        ...
                        <div class="row mb-3">
                            <div class="col-4">
                                ...
                                <input type="text"
                                       ...
                                       id="contact_name" name="contact_name" value="<?=$invoice->contact_name ?>">
                            </div>
                            <div class="col-4">
                                ...
                                <input type="text"
                                       ...
                                       id="contact_phone" name="contact_phone" value="<?=$invoice->contact_phone ?>">
                            </div>
                            <div class="col-4">
                                ...
                                <input type="text"
                                       ...
                                       id="contact_mail" name="contact_mail" value="<?=$invoice->contact_mail ?>">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-12">
                                <label for="notes" class="form-label">Rechnungsinfo</label>
