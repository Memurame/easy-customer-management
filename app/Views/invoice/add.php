                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <div class="input-icon mb-2">
                                    <input class="form-control tabler-datepicker-icon <?php if(session('errors.invoice')) : ?>is-invalid<?php endif ?>" id="invoice" name="invoice" value="<?=old('invoice') ?>">
                        ...
                        <div class="row mb-3">
                            <div class="col-4">
                                ...
                                <input type="text"
                                       class="form-control <?php if(session('errors.contact_name')) : ?>is-invalid<?php endif ?>"
                                       id="contact_name" name="contact_name" value="<?=old('contact_name') ?? profile()->firstname . ' ' . profile()->lastname ?>">
                                <div class="invalid-feedback"><?= session('errors.contact_name') ?></div>
                            </div>
                            <div class="col-4">
                                <label for="contact_phone" class="form-label">Telefon direkt</label>
                                <input type="text"
                                       class="form-control <?php if(session('errors.contact_phone')) : ?>is-invalid<?php endif ?>"
                                       id="contact_phone" name="contact_phone" value="<?=old('contact_phone') ?? profile()->phone ?>">
                            ...
                            <div class="col-4">
                                ...
                                <input type="text"
                                       ...
                                       id="contact_mail" name="contact_mail" value="<?=old('contact_mail') ?? auth()->user()->email ?>">
