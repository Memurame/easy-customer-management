                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                <div class="col-12">
                                    ...
                                    <select name="right" id="right" class="form-select tomselect-multiple-check" multiple>
                                        ...
                                        <option value="<?=$key ?>" <?= (in_array($key, $user->getGroups())) ? 'selected' : '' ?>><?=$group['title']?></option>
                            ...
                            <div class="row mb-3">
                                <div class="col-12">
                                    ...
                                    <input type="mail" class="form-control <?php if(session('errors.email')) : ?>is-invalid<?php endif ?>" id="email" name="email" value="<?=$user->email ?>">
                            ...
                            <div class="row mb-3">
                                <div class="col-12">
                                    ...
                                    <input type="password" class="form-control <?php if(session('errors.password')) : ?>is-invalid<?php endif ?>" id="password" name="password" placeholder="****">
