                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    <div class="col-12">
                                        ...
                                        <input type="text"
                                               class="form-control <?php if(session('errors.phone')) : ?>is-invalid<?php endif ?>" id="phone"
                                ...
                                <div class="row mb-3">
                                    <div class="col-12">
                                        ...
                                        <input type="text"
                                               class="form-control <?php if(session('errors.department')) : ?>is-invalid<?php endif ?>" id="department"
