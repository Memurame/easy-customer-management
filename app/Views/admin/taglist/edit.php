                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select tomselect-default" name="class">
                                    <option <?=($taglist->class == 'text-bg-primary') ? 'selected' : ''?>>text-bg-primary</option>
                                    <option <?=($taglist->class == 'text-bg-dark') ? 'selected' : ''?>>text-bg-dark</option>
                                    <option <?=($taglist->class == 'text-bg-info') ? 'selected' : ''?>>text-bg-info</option>
                                    <option <?=($taglist->class == 'text-bg-warning') ? 'selected' : ''?>>text-bg-warning</option>
                                    <option <?=($taglist->class == 'text-bg-danger') ? 'selected' : ''?>>text-bg-danger</option>
                                </select>
                            </div>
                        </div>
                    </div>
