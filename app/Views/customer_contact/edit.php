                        ...
                        <div class="row mb-3">
                            <div class="col-md-3">
                                ...
                                <select id="typ" name="typ"
                                        class="form-select <?php if(session('errors.typ')) : ?>is-invalid<?php endif ?>">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text"
                                       ...
                                       id="firstname" name="firstname" value="<?=$contact->firstname ?>">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text"
                                       ...
                                       id="lastname" name="lastname" value="<?=$contact->lastname ?>">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text"
                                       ...
                                       id="mail" name="mail" value="<?=$contact->mail ?>">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-5">
                                ...
                                <input type="text"
                                       ...
                                       name="street" value="<?=$contact->street ?>">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="text"
                                       ...
                                       id="postcode" name="postcode" value="<?=$contact->postcode ?>">
