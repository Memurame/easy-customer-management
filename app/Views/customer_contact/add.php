                ...
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-md-3">
                            ...
                            <select id="typ" name="typ" class="form-select tomselect-default <?php if(session('errors.typ')) : ?>is-invalid<?php endif ?>">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control <?php if(session('errors.firstname')) : ?>is-invalid<?php endif ?>" id="firstname" name="firstname" value="<?=old('firstname') ?>">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control <?php if(session('errors.lastname')) : ?>is-invalid<?php endif ?>" id="lastname" name="lastname" value="<?=old('lastname') ?>">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="number" class="form-control <?php if(session('errors.postcode')) : ?>is-invalid<?php endif ?>" id="postcode" name="postcode" value="<?=old('postcode') ?>">
