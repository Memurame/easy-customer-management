...
<form method="post">
    ...
    <div class="row g-3 pb-3">
        <div class="col-2">
            ...
            <input type="text" class="form-control <?php if(session('errors.customernumber')) : ?>is-invalid<?php endif ?>" id="customernumber" name="customernumber" value="<?=old('customernumber') ?>">
        </div>
        <div class="col-md-10">
            <label for="company" class="form-label">Firmenname</label>
            <input type="text" class="form-control <?php if(session('errors.company')) : ?>is-invalid<?php endif ?>" id="company" name="company" value="<?=old('company') ?>">
        </div>
        <div class="col-md-4">
            <label for="contact_mail" class="form-label">E-Mail <span class="text-danger">*</span></label>
            <input type="text" class="form-control <?php if(session('errors.contact_mail')) : ?>is-invalid<?php endif ?>" id="contact_mail" name="contact_mail" value="<?=old('contact_mail') ?>">
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md-2">
            ...
            <input type="text" class="form-control <?php if(session('errors.postcode')) : ?>is-invalid<?php endif ?>" id="postcode" name="postcode" value="<?=old('contact_firstname') ?>">
        </div>
        <div class="col-md-5">
