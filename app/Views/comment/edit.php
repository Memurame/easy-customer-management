...
<form method="post">
    <div class="d-flex border-bottom pb-2 mb-4">
        <div class="p-1 flex-grow-1">
            <ol class="breadcrumb my-0 ">
                ...
                <li class="breadcrumb-item"><a href="<?=base_url()?><?=route_to('invoice.index')?>">Kommentar</a></li>
    ...
    <div class="row g-3">
        ...
        <div class="col-12">
            ...
            <textarea class="form-control" rows="7" id="comment" name="comment"><?=$comment->comment ?></textarea>
        </div>
    </div>
</form>
