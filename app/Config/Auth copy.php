...
class Auth extends ShieldAuth
{
    ...
    public array $views = [
        ...
        'action_email_2fa_email'      => '\App\Views\templates\email\email_2fa_email',
        'action_email_activate_show'  => '\App\Views\auth\email_activate_show',
        'action_email_activate_email' => '\App\Views\templates\email\email_activate_email',
        'magic-link-login'            => '\App\Views\auth\magic_link_form',
        'magic-link-message'          => '\App\Views\auth\magic_link_message',
        'magic-link-email'            => '\App\Views\templates\email\magic_link_email',
    ];
